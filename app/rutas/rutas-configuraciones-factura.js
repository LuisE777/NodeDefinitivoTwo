module.exports = function (router, Sucursal, ConfiguracionFactura, Clase, ConfiguracionGeneralFactura, ensureAuthorizedlogged, Empresa) {
	...
	router.route('/configuraciones-factura/:id_configuracion')
		.put(ensureAuthorizedlogged,function (req, res) {
			ConfiguracionFactura.update({
				...
				id_formato_con_firma_factura: req.body.configuracionFactura.formatoConFirmaFactura.id,
				...
				id_tipo_configuracion:req.body.configuracionFactura.tipoConfiguracion.id,
				...
				id_formato_con_firma_nota_venta: req.body.configuracionFactura.formatoConFirmaNotaVenta.id,
				...
				id_tipo_configuracion_nota_servicio: req.body.configuracionFactura.tipoConfiguracionNotaServicio.id
	...
	router.route('/configuracion-general-factura/:id_configuracion')
		.put(ensureAuthorizedlogged,function (req, res) {
			ConfiguracionGeneralFactura.update({
				...
				id_formato_con_firma_factura: req.body.formatoConFirmaFactura.id,
				...
				id_formato_con_firma_nota_venta: req.body.formatoConFirmaNotaVenta.id,
				...
				id_tipo_configuracion_nota_servicio: req.body.tipoConfiguracionNotaServicio.id
	...
	router.route('/configuracion-impresion/empresa/:id_empresa/sucursal/:id_sucursal')
		...
		router.route('/configuracion-general-Empresa/:id_empresa')
		.post(ensureAuthorizedlogged,function (req, res) {
			Empresa.update({
				ver_precio_compra_en_venta:req.body.ver_precio_compra_en_venta,
				ver_usuario_en_ticket:req.body.ver_usuario_en_ticket
			},{
				where:{id:req.body.empresa}
			}).then((result)=>
			{
				res.json({mensaje:'Configuración: Ver precio compra en pantalla venta actualizado.'})
			})
			.catch((err)=>
			{
				res.json({mensaje:' ERROR :Configuración: Ver precio compra en pantalla no se pudo actualizar.'})
			})
		});
}