	...
	router.route('/anticipo-cliente/cliente/:id_cliente')
		.post(function (req, res) {
			Sucursal.find({
				...
				if(!sucursalEncontrada.activo) return res.json({mensaje:'La sucursal '+sucursalEncontrada.nombre+' está deshabilitada. No se pueden realizar cambios.', hasErr:true})
