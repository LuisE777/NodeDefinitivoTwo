module.exports = function (sequelize, Sequelize) {
	var ConfiguracionGeneralFactura = sequelize.define('agil_configuracion_general_factura', {
		...
		id_formato_con_firma_factura: {
			type: Sequelize.INTEGER,
			field: 'formato_con_firma_factura'
		},
		...
		id_formato_con_firma_nota_venta: {
			type: Sequelize.INTEGER,
			field: 'formato_con_firma_nota_venta'
		},
		...
		id_tipo_configuracion_nota_servicio: {
			type: Sequelize.INTEGER,
			field: 'tipo_configuracion_nota_servicio'
		}
