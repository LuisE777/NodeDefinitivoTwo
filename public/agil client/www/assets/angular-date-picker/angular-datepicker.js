  ...
  var A_DAY_IN_MILLISECONDS = 86400000
          ...
          '<div class="_720kb-datepicker-calendar-header">',
            '<div class="_720kb-datepicker-calendar-header-middle _720kb-datepicker-mobile-item _720kb-datepicker-calendar-month">',
              '<select ng-model="month" title="{{ dateMonthTitle }}" ng-change="selectedMonthHandle(month)">',
                '<option ng-repeat="item in months" ng-selected="item.nombre_corto === month" ng-disabled=\'!isSelectableMaxDate(item + " " + day + ", " + year) || !isSelectableMinDate(item + " " + day + ", " + year)\' ng-value="item.nombre_corto" value="item.nombre_corto">',
                  '{{ item.nombre }}',
                '</option>',
              '</select>',
            '</div>',
    ...
    , datepickerDirective = function datepickerDirective($window, $compile, $locale, $filter, $interpolate, $timeout) {
      ...
      var linkingFunction = function linkingFunction($scope, element, attr) {
        ...
        $scope.months = [
          {nombre_corto: "January", nombre: "Enero"},
          {nombre_corto: "February", nombre: "Febrero"},
          {nombre_corto: "March", nombre: "Marzo"},
          {nombre_corto: "April", nombre: "Abril"},
          {nombre_corto: "May", nombre: "Mayo"},
          {nombre_corto: "June", nombre: "Junio"},
          {nombre_corto: "July", nombre: "Julio"},
          {nombre_corto: "August", nombre: "Agosto"},
          {nombre_corto: "September", nombre: "Septiembre"},
          {nombre_corto: "October", nombre: "Octubre"},
          {nombre_corto: "November", nombre: "Noviembre"},
          {nombre_corto: "December", nombre: "Diciembre"}
        ]
        ...
        $scope.daysInString = ['Dom','Lun','Mar','Mié','Juv','Vie','Sáb']
