(function() {
  ...
  angular.module('swangular', []).provider('SweetAlert', function ProvideSwangular() {
    return {
    ...
    function instantiateSwangular($compile, $http, $rootScope, $q, $controller, $injector, $templateCache, $timeout) {
      ...
      function swal_question(message, customOptions) {
        var options = angular.extend(
          {
            title: 'Question',
            text: message,
      ...
      function showValidationMessage(mensaje) {
        $rootScope.$evalAsync(function() {
