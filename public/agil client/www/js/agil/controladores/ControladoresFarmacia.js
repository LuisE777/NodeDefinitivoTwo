angular.module('agil.controladores')
    ...
    .controller('ControladoresFarmacia', ['$scope', '$localStorage', '$location', '$templateCache','$route', '$filter', '$window', '$timeout', 'blockUI', 'ClasesTipo', 'ConfiguracionVentaVistaDatos',
        ...
        $scope.buscarInventarios = function (idAlmacen, pagina, itemsPagina, texto, columna, direccion, cantidad) {
            ...
            var promesa = InventarioPaginador($scope.usuario.id_empresa, idAlmacen, pagina, itemsPagina, texto, columna, direccion, cantidad, undefined, undefined, $scope.usuario.id, false);
