				...
				var datosCliente = promesa.then(function (datos){
					if (datos.length > 0) {
						if(query.id){
							for (let index = 0; index < datos.length; index++) {
								...
								if(query.id == idExist.id){
									...
									SweetAlert.swal({
										...
										text: "“El Código "+$scope.cliente.codigo+", con razón social '"+datos[0].razon_social+"', ya se encuentra registrado, si continua duplicará el registro de CÓDIGO !!!",
										icon: 'warning',
							...
							SweetAlert.swal({
								title: "Desea Continuar??",
								text: "“El Código "+$scope.cliente.codigo+", con razón social '"+datos[0].razon_social+"', ya se encuentra registrado, si continua SOLO MODIFICARÁ EL REGISTO YA ESXISTENTE CON ESTE CÓDIGO !!!",
								icon: 'warning',
								showCancelButton: true,
								confirmButtonColor: '#3085d6',
								cancelButtonColor: '#d33',
						...
						if(query.id){
							for (let index = 0; index < datos.length; index++) {
								...
								if(query.id == idExist.id){
									...
									SweetAlert.swal({
										title: "Desea Continuar??",
										text: "“El NIT "+$scope.cliente.nit+", con razón social '"+datos[0].razon_social+"', ya se encuentra registrado, si continua duplicará el registro de NIT !!!",
										icon: 'warning',
										showCancelButton: true,
										confirmButtonColor: '#3085d6',
										cancelButtonColor: '#d33',
							...
							SweetAlert.swal({
								title: "Desea Continuar??",
								text: "“El NIT "+$scope.cliente.nit+", con razón social '"+datos[0].razon_social+"', ya se encuentra registrado, si continua SOLO SE MODIFICARÁ EL REGISTRO YA EXISTENTE CON ESTE NIT !!!",
								icon: 'warning',
								showCancelButton: true,
								confirmButtonColor: '#3085d6',
								cancelButtonColor: '#d33',
 ...
 */
		...
		$scope.generarExcelComprobacionDatosClientes = function (clientes, configuracion) {
			$scope.obtenerClientes()
			var data = [["N°", "CODIGO", "CLIENTE", "NIT PRINCIPAL", "RAZÓN SOCIAL PRINCIPAL", "DIRECCION", "TELEFONO UNO", "TELEFONO DOS", "TELEFONO TRES", "UBIC. GEO.", "RUBRO", "CATEGORIA", "FECHA IMP. 1", "FECHA IMP. 2", "TEXTO 1", "TEXTO 2","CODIGO RAZONES CLIENTE", "RAZONES CLIENTE", "NIT -RAZON", "CODIGO SAP", "CODIGO DESTINO", "DESTINOS", "DIRECCION DESTINO"]]
			var iu = []
			var index = 0;
