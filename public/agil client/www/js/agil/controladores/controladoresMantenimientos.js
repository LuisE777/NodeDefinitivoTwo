angular.module('agil.controladores')
    .controller('ControladorMantenimientos', ['$scope', 'blockUI', '$localStorage', '$location', '$templateCache', '$route', 'Usuario','Paginator', function ($scope, blockUI, $localStorage, $location, $templateCache, $route, Usuario,Paginator) {
        ...
        ejecutarScriptsMantenimientos($scope.idModalInicioMantenimiento, $scope.idModalOTNuevo, $scope.idModalwizardContainerOTNuevo, $scope.idModalFacturaServicioExterno,
            $scope.idModaRepuestosOT, $scope.idModalLiquidacionMantenimiento, $scope.idModalwiZardcontainerliquidacionmantenimiento);
    });
