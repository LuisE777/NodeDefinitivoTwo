angular.module('agil.servicios')
	...
	.factory('RutaClienteBusquedaCodigo', ['$resource', function ($resource) {
		return $resource(restServer + "busquedaClienteCodigo/empresa/:id_empresa/texto/:texto");
	}])

	.factory('ListaClienteCodigo', ['RutaClienteBusquedaCodigo', '$q', function (RutaClienteBusquedaCodigo, $q) {
		var res = function (idEmpresa, texto) {
			var delay = $q.defer();
			RutaClienteBusquedaCodigo.query({ id_empresa: idEmpresa, texto: texto}, function (entidades) {
				delay.resolve(entidades);
			}, function (error) {
					delay.reject(error);
				});
	...
	.factory('RutaClienteBusquedaNit', ['$resource', function ($resource) {
		return $resource(restServer + "busquedaClienteNit/empresa/:id_empresa/texto/:texto");
	}])

	.factory('ListaClienteNit', ['RutaClienteBusquedaNit', '$q', function (RutaClienteBusquedaNit, $q) {
		var res = function (idEmpresa, texto) {
			var delay = $q.defer();
			RutaClienteBusquedaNit.query({ id_empresa: idEmpresa, texto: texto}, function (entidades) {
				delay.resolve(entidades);
			}, function (error) {
					delay.reject(error);
				});
