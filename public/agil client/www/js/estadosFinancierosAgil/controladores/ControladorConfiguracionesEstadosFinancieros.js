angular.module('agil.controladores')
    ...
    .controller('ControladorConfiguracionesEstadosFinancieros', function ($scope, $localStorage, $location, $templateCache, $route, blockUI,
        ClasesTipoEmpresa, ClasesTipo, ObtenerGestionesEEFF, GuardarGestionesEEFF,GuardarConfiguracionImpresion,ObtenerConfiguracionImpresion, SweetAlert) {
        ...
        $scope.obtenerGestionesEmpresa = function () {
            blockUI.start()
            $scope.gestionesEF = []
        ...
        $scope.guardarConfiguracionImpresion = function (datos) {
            ...
            promesa.then(function(dato){
                ...
                $scope.cerrarModalDetalleImpresion()
                blockUI.stop()
            })
        }
