angular.module('agil.servicios')
	...
	.factory('alertasDespachoCantidadRuta',  ['$resource',function ($resource) {
		return $resource(restServer + "alertas/pedidos/cantidad/:id_empresa", null,
			{
				'update': { method: 'PUT' }
			});
	}])
	.factory('alertasDespachoCantidad', ['alertasDespachoCantidadRuta', '$q', function (alertasDespachoCantidadRuta, $q) {
		var res = function (idEmpresa) {
			var delay = $q.defer();
			alertasDespachoCantidadRuta.get({ 
	...
	.factory('SaveGtmDetalleDespachoAlerta', ['$resource', function ($resource) {
		return $resource(restServer + "gtm-detalle-despacho/empresa/:id_empresa/fecha/:fecha", null,
			{
				'update': { method: 'PUT' }
			});
	}])
	.factory('GuardarGtmDetalleDespachoAlerta', ['SaveGtmDetalleDespachoAlerta', '$q', function (SaveGtmDetalleDespachoAlerta, $q) {
		var res = function (id_empresa, fecha, gtm_detalles_despacho_seleccionados, id_almacen_despacho, id_sucursal_despacho) {
			var delay = $q.defer();
			SaveGtmDetalleDespachoAlerta.update({
				id_empresa: id_empresa,
				fecha: fecha
			}, {
					detalles_despacho: gtm_detalles_despacho_seleccionados,
					id_almacen: id_almacen_despacho,
